...
export const metadata: Metadata = {
  title: "Dashboard legado | Brincar Educando",
  robots: { index: false },
};

export default async function DashboardLegadoPage({ searchParams }: { searchParams: Promise<{ momento?: string | string[] }> }) {
    ...
    <QuietBackdrop className="dashboard-page min-h-screen">
      <header className="dashboard-header">
        <div className="dashboard-greeting min-w-0">
          ...
          <div className="dashboard-child-row flex flex-wrap items-center gap-x-3 gap-y-1 text-xs sm:text-sm text-[var(--color-muted-foreground)]">
      ...
      <div className="dashboard-content">
        ...
        {child && !needsSelection && (
          <section className="dashboard-context" aria-labelledby="dashboard-context-title">
            <div className="dashboard-context-heading">
              <div>
                <p className="dashboard-eyebrow text-[var(--color-primary)]">Uma pista, se ajudar</p>
                <h2 id="dashboard-context-title">O que cabe agora?</h2>
              </div>
              <p>Você já tem uma sugestão. Ajuste apenas se quiser.</p>
            </div>
